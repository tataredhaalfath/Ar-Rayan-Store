    ...
    <div class="box-header with-border">
        <form action="<?= base_url('admin/rekening/edit/') . $rekening['id_rekening']; ?>" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-5">
                    <input type="number" class="form-control" id="nomor_rekening" name="nomor_rekening" placeholder="nomor rekening" required value="<?= $rekening['nomor_rekening']; ?>">
                </div>
            </div>
            <div class="form-group row">
                <label for="nama_pemilik" class="col-sm-4 col-md-3 col-form-label">Nama Pemilik Rekening</label>
                <div class="col-md-5">
                    <input type="text" class="form-control" id="nama_penilik" name="nama_pemilik" placeholder="nama pemilik rekening" required value="<?= $rekening['nama_pemilik']; ?>">
                </div>
            </div>
