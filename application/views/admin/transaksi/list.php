                ...
                <tr>
                    ...
                    <td><?= $header_transaksi['nama_pelanggan']; ?>
                        <br><small>
                            ...
                            <br>Alamat Pengiriman: <?= $header_transaksi['alamat']; ?>
                        </small>
                    </td>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <a href="<?= base_url('admin/transaksi/cetak/' . $header_transaksi['kode_transaksi']); ?>" class="btn btn-warning btn-sm"><i class="fa fa-check"> Status</i></a>
                        </div>
